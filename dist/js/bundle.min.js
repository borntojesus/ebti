document.addEventListener("DOMContentLoaded",function(){let e=document.getElementById("burgerMenu"),t=document.getElementById("mobileMenu");e&&t&&e.addEventListener("click",function(){e.classList.toggle("active"),t.classList.toggle("active")}),"undefined"!=typeof $&&0<$(".services__slider").length&&$(".services__slider").slick({slidesToShow:2,slidesToScroll:2,infinite:!0,arrows:!0,dots:!0,swipe:!0,nextArrow:'<button type="button" class="slick-next">→</button>',prevArrow:!1,customPaging:function(e,t){return'<button class="custom-dot"></button>'},responsive:[{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1,dots:!0}}]});var i=document.querySelectorAll(".pricing-block__custom-dropdown");0<i.length&&i.forEach(t=>{let i=t.querySelector(".pricing-block__dropdown-selected"),o=t.querySelector(".pricing-block__dropdown-options"),s=t.querySelector("input[type='hidden']"),n=t.closest(".pricing-block__form").querySelector(".modal__dropdown-text");i&&o&&(i.addEventListener("click",()=>{o.classList.toggle("active")}),o.querySelectorAll(".modal__dropdown-option").forEach(e=>{e.addEventListener("click",e=>{var t=e.target.textContent,e=e.target.dataset.value;i.innerHTML=`<div class="modal__dropdown-text">${t}</div>`,s&&(s.value=e),n&&(n.value=t),o.classList.remove("active")})}),document.addEventListener("click",e=>{t.contains(e.target)||o.classList.remove("active")}))});let o=document.getElementById("pricingPhone"),s=(o&&(o.addEventListener("input",function(){let e=o.value.replace(/\D/g,""),t="+";0<(e=(e=e.startsWith("380")?e:"380"+e).slice(0,12)).length&&(t+=e.slice(0,3)),3<e.length&&(t+=" ("+e.slice(3,5)),5<e.length&&(t+=") "+e.slice(5,8)),8<e.length&&(t+="-"+e.slice(8,10)),10<e.length&&(t+="-"+e.slice(10,12)),o.value=t}),o.addEventListener("blur",function(){o.value.length<17?o.setCustomValidity("Будь ласка, введіть номер у форматі +380 (XX) XXX-XX-XX"):o.setCustomValidity("")}),o.addEventListener("focus",function(){o.setCustomValidity("")})),document.querySelector(".regions")),n=document.querySelector(".regions__toggle"),l=(s&&n&&n.addEventListener("click",function(){s.classList.toggle("regions--expanded"),n.innerText=s.classList.contains("regions--expanded")?"Приховати відділення":"Переглянути усі відділення"}),document.querySelectorAll(".faq__question")),r=(0<l.length&&l.forEach(i=>{i.addEventListener("click",()=>{let o=i.nextElementSibling;var e=i.querySelector(".faq__icon"),t=(l.forEach(e=>{var t=e.nextElementSibling,i=e.querySelector(".faq__icon");t!==o&&(t.classList.remove("active"),e.classList.remove("faq__question--active"),i)&&i.classList.remove("active")}),o.classList.contains("active"));o.classList.toggle("active",!t),i.classList.toggle("faq__question--active",!t),e&&e.classList.toggle("active",!t)});let t=i.querySelector(".faq__icon");t&&t.addEventListener("click",e=>{e.stopPropagation();let o=i.nextElementSibling;l.forEach(e=>{var t=e.nextElementSibling,i=e.querySelector(".faq__icon");t!==o&&(t.classList.remove("active"),e.classList.remove("faq__question--active"),i)&&i.classList.remove("active")});e=o.classList.contains("active");o.classList.toggle("active",!e),t.classList.toggle("active",!e),i.classList.toggle("faq__question--active",!e)})}),document.getElementById("telegramForm")),a=(r&&r.addEventListener("submit",async function(e){e.preventDefault();var e=document.body.dataset.pagePermalink||"/",t=document.body.dataset.pageTitle||document.title,i=new FormData(this),o=i.get("name"),s=i.get("phone"),n=i.get("service");i.get("documentType");await fetch("https://api.telegram.org/bot7832589193:AAHN8RseNQWUoctiWEZZPXIia5fmiStL0DY/sendMessage",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:"-1002329526352",text:`
🔔 *Нова заявка на послуги*:
  ...
  *Посилання*: https://kpkorbti.com.ua${e}
          `,parse_mode:"Markdown"})}),r.querySelectorAll("input, select, textarea").forEach(e=>{"checkbox"===e.type||"radio"===e.type?e.checked=!1:e.value=""});r.querySelectorAll(".pricing-block__input, .pricing-block__custom-dropdown, .pricing-block__label, .pricing-block__button").forEach(e=>e.style.display="none");i=document.getElementById("pricingModalTitle"),i&&(i.style.display="none"),o=document.querySelector(".pricing-block__success-message");o&&(o.style.display="block")}),document.querySelectorAll(".menu__link")),d=document.querySelectorAll(".privacy-policy__content");0<a.length&&a.forEach(e=>{e.addEventListener("click",e=>{e.preventDefault(),a.forEach(e=>e.classList.remove("menu__link--active")),e.target.classList.add("menu__link--active"),d.forEach(e=>{e.style.display="none"});e=e.target.getAttribute("href").substring(1),e=document.getElementById(e);e&&(e.style.display="block")})})}),document.addEventListener("DOMContentLoaded",function(){let r=document.getElementById("modal");var e=document.querySelectorAll(".open-modal"),t=document.getElementById("closeModal");let a=r?.querySelector(".modal__form"),d=r?.querySelector(".modal__title"),c=r?.querySelector(".modal__subtitle"),p=r?.querySelector(".modal__info-footer"),i=(0<e.length&&e.forEach(e=>{e.addEventListener("click",()=>{r&&(r.style.display="block")})}),t&&t.addEventListener("click",()=>{r&&(r.style.display="none")}),window.addEventListener("click",e=>{e.target===r&&(r.style.display="none")}),r?.querySelector('input[type="tel"]'));i&&(i.addEventListener("input",function(){let e=i.value.replace(/\D/g,""),t="+";0<(e=(e=e.startsWith("380")?e:"380"+e).slice(0,12)).length&&(t+=e.slice(0,3)),3<e.length&&(t+=" ("+e.slice(3,5)),5<e.length&&(t+=") "+e.slice(5,8)),8<e.length&&(t+="-"+e.slice(8,10)),10<e.length&&(t+="-"+e.slice(10,12)),i.value=t}),i.addEventListener("blur",function(){i.value.length<17?i.setCustomValidity("Будь ласка, введіть номер у форматі +380 (XX) XXX-XX-XX"):i.setCustomValidity("")}),i.addEventListener("focus",function(){i.setCustomValidity("")})),a&&a.addEventListener("submit",async function(e){e.preventDefault();var e=document.body.dataset.pagePermalink||"/",t=document.body.dataset.pageTitle||document.title,i=new FormData(this),o=i.get("name"),s=i.get("phone"),n=i.get("service"),i=(i.get("documentType"),`
🔔 *Нова заявка на послуги*:
  *Ім'я*: ${o}
  *Телефон*: ${s}
  *Послуга*: ${n}
